...
def main():
    ...
    llm = LLM(model="/home/zhangningboo/workspace/vlm/znb-Qwen3-VL/model/Qwen/Qwen3-VL-4B-Instruct")
...
# export LD_LIBRARY_PATH=/home/zhangningboo/.local/share/mamba/envs/tensorrt-llm/lib:${LD_LIBRARY_PATH}